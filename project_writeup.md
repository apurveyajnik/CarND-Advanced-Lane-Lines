...
I used a combination of color (convert to HLS channel, HLV channel) and gradient thresholds  to generate a binary image (thresholding steps in 3rd code cell in file 'pipeline.ipynb').  Here's an example of my output for this step.  (note: this is not actually from one of the test images)
